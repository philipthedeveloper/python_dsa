...
def merge(left, right):
    ...
    while left_head or right_head:
        ...
        if left_head is None:
            ...
            # Call next on right to set loop conditions to false
            right_head = right_head.next_node
        # If the head node of right is None, we're past the tail
        # Add the tail node from left to merged linked_list
            ...
            # If data on left is less than right, set current to left_node
            if left_data < right_data:
                current.next_node = left_head
                # Move left head to next node
                left_head = left_head.next_node
            # If data on left is greater than right, set current to right_node
            else:
                current.next_node = right_head
